...
{
    public partial class frmOrderByClientCount : Form
    {
        public frmOrderByClientCount()
        {
            InitializeComponent();
        }
        ...
        {
            string sqlStr = "select SongID,SongName,SingerName,url,a.SingerID,ClientCount from Song a,Singer b where a.SingerID=b.SingerID order by ClientCount desc";
